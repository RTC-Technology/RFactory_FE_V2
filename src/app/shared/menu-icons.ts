/**
 * Icon presets offered by the Menu Manager's picker.
 *
 * Kept out of MenuService on purpose: that service ships in the initial bundle (the
 * shell and sidebar need it on boot), and these markup strings would ride along even
 * though only the lazy-loaded Menu Manager reads them.
 */
export const ICONS = {
  ...
  management: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>`,
  ...
  workspace:  `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>`,
