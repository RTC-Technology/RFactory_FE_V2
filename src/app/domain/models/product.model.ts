...
export interface ProductDto {
	...
	warrantyPeriodUnit?: number | null;

	vatRate?: number | null;

	standardProductionTime?: number | null;
...
export const PRODUCT_NATURES = [
	{ labelKey: 'product.nature.finishedProduct', value: 1 },
	{ labelKey: 'product.nature.rawMaterial', value: 2 },
	{ labelKey: 'product.nature.goods', value: 3 },
	{ labelKey: 'product.nature.toolsAndEquipment', value: 4 },
];

export const PRODUCT_WARRANTY_PERIOD_UNITS = [
	{ labelKey: 'product.warrantyUnit.day', value: 1 },
	{ labelKey: 'product.warrantyUnit.month', value: 2 },
	{ labelKey: 'product.warrantyUnit.year', value: 3 },
];
...
export interface RoutingDto {
	...
	version?: string | null;
	isActive: boolean;
	routingOperations: RoutingOperationDto[];
}

export type RoutingRequest = Omit<RoutingDto, 'id'> & {
	routingOperations?: RoutingOperationRequest[];
};
